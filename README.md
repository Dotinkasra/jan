...
## 使い方
### 0. ダウンロードについて
Windowsでexeファイルをダウンロードして実行します。  
いろいろとセキュリティアラートが出ると思いますので、信頼できる場合は起動してください。  
PCを害する意図のコードは一切含まれておりませんのでご安心ください。

[ダウンロードページ](https://github.com/Dotinkasra/jan/releases)
...
大量の牌譜保存などによる雀魂のアカウント制限にはお気をつけください。
